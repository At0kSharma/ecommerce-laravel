...
<!-- Top Sale -->
    <div class="container pt-2">
        <div class="d-flex justify-content-between">
            <h4 class="h4">New Arival</h4>
            <a href="{{route('shop.index')}}" class="btn btn-outline-primary p-1 m-0">Explore</a>
        </div>
        <div class="row">
            <div class="col-sm-12 d-flex flex-wrap justify-content-center ">
                ...
                <div class="card m-2 p-0 justify-content-between border-0 product-card text-center position-relative">
                    ...
                    <a href="{{route('product',['id' => $product->id,'type' => $product->type,'body' => $product->body])}}"><img class="card-img-top br-10" src="data:image/jpeg;base64,{{base64_encode($product->preview)}}" alt="Card image cap"></a>
